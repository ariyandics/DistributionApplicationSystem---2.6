...
Module PublicMod
    Public StrKoneksi, MDBKoneksi, StrFilter, PathMDB, StrKoneksi2, strsql As String
    ...
    Public StrUserid, StrNamaUser, termOP As String
    ...
    Public iddiv, iddept, idsubdept, idctgr As Integer
    ...
    Public bg, wp, atas, masuk, logo, statusToko As String
    ...
    Public NamaProduk, namatoko, kodetipetoko, alamattoko, telptoko, kodejnslokasi As String
    ...
    Public icoadd, icoedit, icodelete, icoapprove, icosave, icoprint, icocancel, icoclear, icorefresh, icoproses As String
